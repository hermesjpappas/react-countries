    ...
    <div className='w-full flex flex-col items-center mb-24'>
      <div className='w-full flex justify-between p-2 sm:p-4 lg:px-20'>
        <div className='relative'>
          <FontAwesomeIcon
            icon={faSearch}
            className='text-gray-400 absolute top-2 left-1 pb-1 sm:text-xl sm:top-3 sm:left-3'
          />
          <input
            className='bg-white text-gray-700 dark:bg-gray-600 dark:text-gray-300 text-sm p-1 pl-6 rounded w-44 shadow-lg sm:h-10 sm:w-96 sm:text-base sm:pl-10 focus:outline-none'
            type='text'
        ...
        <select
          ...
          onChange={handleChange}
          className='text-xs rounded bg-white text-gray-700 dark:bg-gray-600 dark:text-gray-300 shadow-lg px-1 sm:w-28 sm:text-center sm:text-base focus:outline-none'
        >
